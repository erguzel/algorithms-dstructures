...
class TopologicalSortTest {
    ...
    void sortTopologicallyIfExists_Khan_ListyGraph() {
        ...
        int [] res1 = instance.sortTopologicallyIfExists_Khan(input1,numberofvertex1, IGraph.GraphTypes.EDGELIST);

        int[][] input2 = SampleData.Csacademy.COURSE_SCHEDULE_1;
        int numberofvertex2 = 6;
        int[] want2 = {5,4,3,2,0,1};
        int[] res2 = instance.sortTopologicallyIfExists_Khan(input2,numberofvertex2,IGraph.GraphTypes.EDGELIST);

        int[][] input3 = SampleData.Csacademy.COURSE_SCHEDULE_2;
        int numberofvertex3 = 6;
        int[] want3 = null;
        int[] res3 =instance.sortTopologicallyIfExists_Khan(input3,numberofvertex3,IGraph.GraphTypes.EDGELIST);

        int[][] input4 = SampleData.Csacademy.COURSE_SCHEDULE_3;
        int numberofvertex4 = 12;
        int[] want4 = {0,3,7,10,5,1,8,11,9,6,2,4};
        int [] res4 = instance.sortTopologicallyIfExists_Khan(input4,numberofvertex4,IGraph.GraphTypes.EDGELIST);
