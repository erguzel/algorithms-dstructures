...
//import java.util.*;
//
//public class ABinarySearchTreeDeprecated {
//
//    public static void main(String[] args) {
//        ABinarySearchTreeDeprecated tree = new ABinarySearchTreeDeprecated();
//        tree.root = new ABinarySearchTreeNode(2);
//        tree.root.insert(4);
//        tree.root.insert(6);
//        tree.root.insert(3);
//        tree.root.insert(12);
...
//
//    public ABinarySearchTreeDeprecated() {
//    }
//
//    public ABinarySearchTreeDeprecated(int rootVal) {
...
//        this.root = this.root.remove1(val,null);
//    }
//    /**
//     * CLASS Inner
//     */
...
//
//        private ABinarySearchTreeNode remove1 (int value,ABinarySearchTreeNode parent){
//            if(this.value == value){
//                ABinarySearchTreeNode prt = parent;
//                boolean isLeftLeaf = this.left == null && this.right == null && (parent.left!=null && this.value == parent.left.value);
//                boolean isRightLeaf = this.left == null && this.right == null && (parent.right != null&& this.value == parent.right.value);
//                if (isLeftLeaf)parent.left = null;
//                else if(isRightLeaf)parent.right =null;
//                boolean isLeft = parent.left != null && parent.left.value == value;
//                boolean isRight = parent.right != null && parent.right.value == value;
//                if (isLeft) {
//                    if(this.left != null){
...
//                if(value<this.value){
//                    if(this.left!= null){
//                        this.left.remove1(value,this);
//                    }
//                }else if(value>this.value){
//                    if(this.right != null){
//                        this.right.remove1(value,this);
//                    }
//                }
//            }
//            return null;
