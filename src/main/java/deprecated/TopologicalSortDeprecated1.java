...
public class TopologicalSortDeprecated1 {
    ...
    public static ALogger<TopologicalSortDeprecated1> LOGGER = new ALogger<>(TopologicalSortDeprecated1.class);
    private int count = 0;

    public static void main(String[] args) {
        int[][] graph = SampleData.Csacademy.COURSE_SCHEDULE_3;
        TopologicalSortDeprecated1 ts = new TopologicalSortDeprecated1();
        ts.test(graph, 12);
